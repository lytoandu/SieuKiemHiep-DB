...
namespace GameDBServer.Logic
{
    ...
    public class UserMoneyMgr
    {
        ...
        public static TCPProcessCmdResults CMT_KT_LOG_RECHAGE_2(DBManager dbMgr, TCPOutPacketPool pool, int nID, byte[] data, int count, out TCPOutPacket tcpOutPacket)
        {
            tcpOutPacket = null;
            string cmdData = null;
            ...
            try
            {
                ...
                if (DBWriter.UpdateRechageData(dbMgr, UserID, Money))
                {
                    RETURN = "1:1";
                }
                else
