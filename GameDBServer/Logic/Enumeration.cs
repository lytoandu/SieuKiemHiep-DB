...
namespace GameDBServer.Logic
{
    ...
    public class RoleParamName
    {
        ...
        public const String MaxTongQianNum1 = "MaxTongQianNum1"; //角色的最大铜钱值
    ...
    public class RoleParamNameInfo
    {
        ...
        private static Dictionary<string, RoleParamType> RoleParamNameTypeDict = new Dictionary<string, RoleParamType>()
        {
            ...
            {"ForeverRecoreS", new RoleParamType("ForeverRecoreS", "ForeverRecoreS", "t_roleparams_2", "pname", "pvalue", -1, -1, 0)},

            {"MaxTongQianNum", new RoleParamType("MaxTongQianNum", "MaxTongQianNum", "t_roleparams_2", "pname", "pvalue", -1, -1, 0)},
...
#region Kiếm Thế
            ...
            {"MaxTongQianNum1", new RoleParamType("MaxTongQianNum1", "MaxTongQianNum1", "t_roleparams_long", "idx", "v28", 10000, 10028, 2)},
