    ...
    public partial class GuildManager
    {
        ...
        public List<GuildShare> CacheAllGuildShare(int GuildID)
        {
            ...
            try
            {
                ...
                string cmdText = string.Format("Select a.RoleID,a.`Share`,a.GuildID,b.rname RoleName,a.`Rank`,a.FamilyID, a.FamilyName from t_guildshare a left join t_roles b on (a.RoleID = b.rid) where a.GuildID = " + GuildID + "");
                //
        ...
        /// <returns></returns>
        public bool InsertGuildShare(string RoleName, int RoleID, double Share, 
            int GuildID, int Rank, int FamilyID, string FamilyName)
        {
            MySQLConnection conn = null;
        ...
        public void UpdateGuildVoteStatus()
        {
            try
            {
                ...
                if (this.ThisWeek != WeekID)
                {
					...
					Console.WriteLine("==> Da thuc hien update toan bo he thong quan ham lanh tho cho sever");
