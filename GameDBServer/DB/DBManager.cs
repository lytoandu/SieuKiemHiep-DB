...
namespace GameDBServer.DB
{
    ...
    public class DBManager
    {
        ...
        {
          //  Console.WriteLine("GetDBRoleInfo111111111111 :" + roleID);
            DBRoleInfo dbRoleInfo = _DBRoleMgr.FindDBRoleInfo(roleID);
          // Console.WriteLine("GetDBRoleInfo2222222222222 :" + roleID);
            if (null == dbRoleInfo)
            {
             //   Console.WriteLine("GetDBRoleInfo333333333 :" + roleID);
                ...
                try
                {
                 //   Console.WriteLine("GetDBRoleInfo4444444444 :" + roleID);
                    if (!dbRoleInfo.Query(conn, roleID))
                    {
                        //Console.WriteLine("GetDBRoleInfo5555555555 :" + roleID);
                        return null;
                    }
                }
                finally
              ...
              //  Console.WriteLine("GetDBRoleInfo666666666 :" + roleID);
        ...
        public void ReloadDBRoleInfo(DBRoleInfo dbRoleInfo)
        {
            MySQLConnection conn = _DBConns.PopDBConnection();

            try
            {
                dbRoleInfo.ReloadRow2RoleInfoc_Occupations(conn, dbRoleInfo);
            }
            finally
            {
                _DBConns.PushDBConnection(conn);
