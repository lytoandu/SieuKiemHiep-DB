...
namespace GameDBServer.DB
{
	...
	public class DBUserInfo
    {
        ...
        public bool Query( MySQLConnection conn, string userID )
        {
            ...
            MySQLSelectCommand cmd = new MySQLSelectCommand(conn, new string[] { "rid", "userid", "rname", "sex", "occupation", "level", "zoneid" },
            ...
            /// Truy vấn thông tin từ bảng t_pushmessageinfo
