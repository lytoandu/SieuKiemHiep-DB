...
namespace Server.Data
{
    ...
    public class StallData
    {
        ...
        /// <summary>
        /// Thời gian bắt đầu bán theo GoodsDbID
        /// </summary>
        [ProtoMember(14)]
        public Dictionary<int, int> GoodsStartTimeDict = new Dictionary<int, int>();

        /// <summary>
        /// Giá mua ngay theo GoodsDbID (0 = không có)
        /// </summary>
        [ProtoMember(15)]
        public Dictionary<int, int> GoodsBuyoutPriceDict = new Dictionary<int, int>();
        /// <summary>
        /// Thời gian bán theo GoodsDbID (24 / 48 / 72)
        /// </summary>
        [ProtoMember(16)]
        public Dictionary<int, int> GoodsDurationHourDict = new Dictionary<int, int>();
    ...
    public class MiniStallData
    {
        ...
        public string RoleName;
        [ProtoMember(13)]
        public Dictionary<int, int> GoodsStartTimeDict;

        [ProtoMember(14)]
        public Dictionary<int, int> GoodsBuyoutPriceDict;
        [ProtoMember(15)]
        public Dictionary<int, int> GoodsDurationHourDict;
